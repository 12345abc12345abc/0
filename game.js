...
const TWR={
  ...
  laserGrid:   {name:'레이저 그리드', nameEn:'Laser Grid',      price:2000,  color:'#F44336',type:'aoe',      dmg:720,  spd:1.0,  range:2.0, lvM:[1,2.99,4.98,6.98],    upgCosts:[19600,29400,49000],  desc:'범위 내 원석 전체를 동시에 처리한다. 원석이 밀집할수록 효율이 극대화된다.', descEn:'Processes all ores in range simultaneously. Efficiency peaks when ores are clustered.'},
